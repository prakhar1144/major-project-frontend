...
const overviewData = [
  {
    ...
    caption:
      "We're striving to create a blockchain-based solution to revolutionise the EV Charging market by maximising the use of existing charging stations as opposed to installing centralised charging stations on a large scale.",
    image: 'hp_plug.png'
  },
  {
    ...
    caption:
      'Consumers will no longer need to precalculate distance before travelling, suppliers will be able to utilise their outlets during off-peak hours, and a key barrier to the widespread adoption of electric vehicles will be removed.',
    image: 'hp_bolt.png'
  },
  {
    ...
    caption:
      'We are eliminating the issue connected with the centralised model in which power trade will not be transparent and equitable, resulting in the collapse of the entire system.',
    image: 'hp_arrow.png'
  }
];
  ...
  <Grid item sm={4} key={index}>
    <Card sx={{ textAlign: 'center', boxShadow: 'none' }}>
      ...
      <CardActions sx={{ justifyContent: 'center' }}>
        <Button
          size="small"
          sx={{ backgroundColor: 'orangered', color: 'white', borderRadius: '20px', px: 2 }}
          component={Link}
          to={item.buttonLink}
        >
          {item.buttonText}
